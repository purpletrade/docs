...
description: "Don't trust, verify — reproducible builds, on-chain proofs, and SDK audit"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Matcher Program" icon="shield-check" href="https://github.com/purpletrade/percolator-match/actions/runs/21858415743">
    Latest CI run — click to see build logs and artifact hash
  </Card>
</CardGroup>
...
| **SHA-256** | `17ccdb7efef55c93ed3eb4105183d9696605e9c0a368b996e1558a6ecf0328ae` |
...
All payloads use little-endian encoding. Public keys are raw 32-byte arrays. PDA seeds match the Rust `find_program_address` calls exactly. 25 of 27 error variants are mapped (two admin-only variants intentionally omitted). Slab struct offsets checked against `#[repr(C)]` layout rules with alignment and padding.

See [percolator-prog](/repo-percolator-prog) for the full instruction reference.
