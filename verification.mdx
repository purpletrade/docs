...
<CardGroup cols={2}>
  <Card title="Percolator Program (Rust)" icon="github" href="https://github.com/aeyakovenko/percolator-prog">
    Canonical on-chain program source by Anatoly Yakovenko.
  </Card>
  <Card title="Purple.trade SDK" icon="github" href="https://github.com/purpletrade">
    TypeScript SDK implementation — verified byte-for-byte compatible.
  </Card>
</CardGroup>
