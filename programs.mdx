...
The deployed program binary hash:

```
e5d99925ccd118865dfc64262edfd5531b76c4c8e894236a710e8aac300dbb4b
```

Anyone can verify this by cloning [percolator-prog](https://github.com/purpletrade/percolator-prog), building from source, and comparing the output hash against the on-chain binary. A match proves the deployed program is byte-for-byte identical to the open-source code — no hidden modifications.
