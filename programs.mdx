...
- **[OtterSec](https://osec.io/) verified** — programs pass OtterSec's on-chain verification
- **`security.txt`** embedded in the binary — visible on [Solscan](https://solscan.io/account/MTCPqs6RWWUPMHhvZnnB6BLAXS86TDpTaxQW7Pa3aDh) under the Security tab
- Green verification badges on Solana explorers

| Program | Address | Verified Build |
|---------|---------|----------------|
| Percolator | [`PRPLUgjCUxCEzNPP6x7XJVK1WR5XX28Zu8MEyTqvGjF`](https://solscan.io/account/PRPLUgjCUxCEzNPP6x7XJVK1WR5XX28Zu8MEyTqvGjF) | [CI run](https://github.com/purpletrade/percolator-prog/actions/runs/21863687941) |
| Matcher | [`MTCPqs6RWWUPMHhvZnnB6BLAXS86TDpTaxQW7Pa3aDh`](https://solscan.io/account/MTCPqs6RWWUPMHhvZnnB6BLAXS86TDpTaxQW7Pa3aDh) | [CI run](https://github.com/purpletrade/percolator-match/actions/runs/21863835686) |
